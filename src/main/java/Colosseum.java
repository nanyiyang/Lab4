...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (input) {
            ...
            if (tempPokemon.defenseLevel > (MAX_ATK_AND_DEF - tempPokemon.attackLevel)) {
                input = false;
                System.out.println("Sorry. The defense level must be between 1 and" + (MAX_ATK_AND_DEF - tempPokemon.attackLevel));
            } else {
                input = true;
                break;
            }
    ...
    public static void printWhoIsAhead() {
        while (firstPokemon.hitPoints != 0 || secondPokemon.hitPoints != 0) {
